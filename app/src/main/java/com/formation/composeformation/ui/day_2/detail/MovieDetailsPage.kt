...
import com.formation.composeformation.designsystem.utils.RemoveDefaultPadding
import com.formation.composeformation.ui.day_2.detail.component.ExpandableText
import com.formation.composeformation.ui.day_2.detail.component.PersonLayoutView
...
import com.formation.composeformation.ui.day_2.detail.navigation.MovieDetailsNavigator
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                colors = topAppBarColors(
                    containerColor = if (isBackDropImageVisible) Color.Transparent else MaterialTheme.colorScheme.surfaceVariant
                )
            )
        }
    ) {
...
fun MovieDetailsPage(state: MovieDetailsState, lazyListState: LazyListState) {
    ...
    LazyColumn(
        ...
        item {
            Box(
                modifier = Modifier.horizontalNegativePadding(16.dp),
                contentAlignment = Alignment.Center
            ) {
                AsyncImage(
                    modifier = Modifier.fillMaxWidth(),
